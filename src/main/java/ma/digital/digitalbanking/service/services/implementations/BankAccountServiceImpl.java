package ma.digital.digitalbanking.service.services.implementations;

import lombok.AllArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import ma.digital.digitalbanking.dao.entities.*;
...
import ma.digital.digitalbanking.service.mappers.BankAccountMapperImpl;
...
public class BankAccountServiceImpl implements BankAccountService {
    ...
    public AccountHistoryDTO getAccountHistory(String accountId, int page, int size) {
        ...
        List<AccountOperationDTO> accountOperationDTOS = accountOperation.getContent()
                                                            .stream().map(op ->bankAccountMapper.fromAccountOperation(op) ).toList();
